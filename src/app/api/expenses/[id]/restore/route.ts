...
export async function POST(_req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  await prisma.activity.create({ data: { groupId: e.groupId, userId, type: 'expense_restored', metadata: JSON.stringify({ expenseId: id, description: e.description, amount: e.amount }) } })
